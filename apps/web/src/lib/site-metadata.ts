...
export const siteMetadata = {
  name: 'Wutong',
  title: 'Wutong – The Autonomous Company Operating System',
  description:
  ...
  url: baseUrl,
  keywords:
    'Wutong, autonomous company operating system, AI agents, self-driving company, cloud computer, AI automation, agent orchestration, autowork, AI triggers, persistent memory, autonomous workforce, AI operations',
};
