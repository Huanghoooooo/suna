...
export const metadata: Metadata = {
  ...
  keywords:
    'Wutong careers, Wutong jobs, AI startup jobs, autonomous company jobs, San Francisco AI jobs, agent engineering, startup hiring',
  openGraph: {
    title: 'Careers at Wutong – Build the Autonomous Company OS',
    description:
