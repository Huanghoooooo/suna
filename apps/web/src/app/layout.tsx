...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Wutong Team', url: 'https://www.kortix.com' }],
  creator: 'Wutong Team',
  publisher: 'Wutong Team',
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <title>Wutong – The Autonomous Company Operating System</title>
        ...
        <meta name="keywords" content="Wutong, autonomous company operating system, AI agents, self-driving company, cloud computer, AI automation, agent orchestration, autowork, AI triggers, persistent memory, autonomous workforce, AI operations" />
        <meta property="og:title" content="Wutong – The Autonomous Company Operating System" />
        ...
        <meta name="twitter:title" content="Wutong – The Autonomous Company Operating System" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['Wutong', 'Wutong AI', 'Wutong – The Autonomous Company Operating System'],
              url: siteMetadata.url,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'Wutong'],
